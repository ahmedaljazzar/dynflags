...
class TestGeneral(unittest.TestCase):
    ...
    def test_argument_key_validation(self):
        ...
        args = { 1: 'a' }
        self.assertRaises(dynflags.InvalidArgumentKeyTypeException, mgr._validate_arguments, args) # deny int key
    ...
    def test_argument_value_validation(self):
        ...
        args = { 'a': 1 }
        self.assertRaises(dynflags.InvalidArgumentValueTypeException, mgr._validate_arguments, args) # deny int value
    ...
    def test_flag_name_validation(self):
        ...
        self.assertRaises(dynflags.InvalidFlagNameTypeException, mgr._validate_flag_names, bad_flags)
...
class TestReadOnly(unittest.TestCase):
    ...
    def test_add_flags_raises_exception(self, *args):
        mgr = dynflags.DynFlagManager('my-table')
        self.assertRaises(dynflags.ReadOnlyException, mgr.add_flags, ['my-flag'])

    @mock_dynamodb2
    def test_remove_flag_raises_exception(self, *args):
        mgr = dynflags.DynFlagManager('my-table')
        self.assertRaises(dynflags.ReadOnlyException, mgr.remove_flag, 'my-flag')

    @mock_dynamodb2
    def test_remove_flags_raises_exception(self, *args):
        mgr = dynflags.DynFlagManager('my-table')
        self.assertRaises(dynflags.ReadOnlyException, mgr.remove_flags, ['my-flag'])

class TestReadWrite(unittest.TestCase):
    @mock_dynamodb2
    def test_single_global_flag(self, *args):
        mgr = dynflags.DynFlagManager('my-table', autocreate_table=True, read_only=False)
        flag_name = 'my-flag-1'
...
class TestCachedRead(unittest.TestCase):
    ...
    def test_cached_read(self, *args):
        ...
        mgr = dynflags.DynFlagManager('my-table', autocreate_table=True, cache=TestCache())
